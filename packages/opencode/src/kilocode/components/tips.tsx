...
const TIPS = [
  ...
  "Zara can {highlight}configure itself{/highlight} if you ask it",
  "Ask Zara to {highlight}add Supabase MCP globally{/highlight}",
  "Ask Zara to {highlight}create a review agent for this project{/highlight}",
  "Ask Zara to {highlight}add a plugin for desktop alerts{/highlight}",
  "Ask Zara to {highlight}set Claude Sonnet as my default model{/highlight}",
  "Ask Zara to {highlight}make my review agent read-only{/highlight}",
  "Ask Zara to {highlight}require approval before git push{/highlight}",
  "Ask Zara to {highlight}turn off auto-formatting{/highlight}",
  "Ask Zara to {highlight}block access to .env files{/highlight}",
  "Ask Zara to {highlight}turn off the F2 shortcut{/highlight}",
  "Ask Zara to {highlight}match my terminal theme{/highlight}",
  "Ask Zara to {highlight}disable sharing for all sessions{/highlight}",
  "Ask Zara to {highlight}add rules from docs/ai-rules.md{/highlight}",
  "Ask Zara to {highlight}enable tui.scroll_acceleration{/highlight} for smooth macOS-style scrolling",
  "Ask Zara to {highlight}save this workflow as a /command{/highlight}",
  "Zara auto-handles OAuth for remote MCP servers requiring auth",
  "Zara auto-formats files using prettier, gofmt, ruff, and more",
  "Zara uses LSP servers for intelligent code analysis",
  "Use {highlight}zara run{/highlight} for non-interactive scripting",
  "Use {highlight}zara --continue{/highlight} to resume the last session",
  "Use {highlight}zara run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}zara serve{/highlight} for headless API access to Zara",
  "Use {highlight}zara run --attach{/highlight} to connect to a running server",
  "Run {highlight}zara upgrade{/highlight} to update to the latest version",
  "Run {highlight}zara auth list{/highlight} to see all configured providers",
