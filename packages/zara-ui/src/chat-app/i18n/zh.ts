...
export const dict = {
  ...
  "prompt.action.sandbox.enabled": "沙盒已启用。代理 shell 命令被限制在项目和 Zara 目录内。",
  "prompt.action.sandbox.disabled": "沙盒已禁用。点击以将代理 shell 命令的写入限制在项目和 Zara 目录内。",
  ...
  "prompt.action.sandbox.description.enabled": "写入仅限项目和 Zara 目录。",
